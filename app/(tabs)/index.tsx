...
import { useGetEntriesByCategoryQuery } from "~/service/entry/entry-api";
...
export default function EntriesScreen() {
  ...
  const { data: entriesByCategory, isLoading } = useGetEntriesByCategoryQuery();
  ...
  if (
    ...
    Object.keys(entriesByCategory.entries).length === 0
  ) {
    return (
      <SafeAreaView className="flex-1 bg-gray-50">
