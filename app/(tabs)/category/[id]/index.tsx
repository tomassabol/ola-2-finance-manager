...
import { useGetEntriesByCategoryIdQuery } from "~/service/entry/entry-api";
...
export default function CategoryScreen() {
  ...
  const { data: entriesData, isLoading: isEntriesLoading } =
    useGetEntriesByCategoryIdQuery(id);
        ...
        <ScrollView className="flex-1 px-4 py-4">
          ...
          <View className="mt-6">
            <View className="flex-row items-center justify-between mb-3">
              ...
              <Text className="text-sm text-gray-400">
                {entriesData?.total && entriesData.total > 0
                  ? entriesData.total
                  : 0}{" "}
                {entriesData?.total && entriesData.total === 1
                  ? "entry"
                  : "entries"}
              </Text>
            </View>
            ...
            <View className="space-y-2 gap-y-2">
              {entriesData?.entries.length && entriesData.entries.length > 0 ? (
